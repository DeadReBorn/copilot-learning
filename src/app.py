...
activities = {
    ...
    "Basketball Team": {
        "description": "Team practices and games for basketball players",
    ...
    "Drama Club": {
        "description": "Rehearse and perform one-act plays and skits",
    ...
    "Science Club": {
        "description": "Hands-on experiments and exploring scientific ideas",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
